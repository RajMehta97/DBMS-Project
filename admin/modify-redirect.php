            ...
            <div class="page-head">
				...
				<?php
					...
					$sql="UPDATE `customer` SET `first_name`='$first_name',`last_name`='$last_name',
								`email`='$email',`contact_no`='$contact_no',`id_type`='$id_type',`id_number`='$id_num'";
					$res=mysqli_query($conn,$sql);
					if(!$res){
						$success="Failed to update Customer Details";
					}
					else{
					...
					<section class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
								...
								<?php
									$bookingID=$_POST['bookingstuff'];
									$query="SELECT * from customer as c INNER JOIN booking as b ON c.customer_id=b.customer_id WHERE b.booking_id='$bookingID';";
									$query_res=mysqli_query($conn,$query);					
									while($row=mysqli_fetch_array($query_res)){
									echo "<tr>";
