...
<head>
    ...
    <title>MONTE CARLO CANCEL BOOKING</title>
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['cancelled']==1){
						if (isset($_POST["bookingID"]) && isset($_POST["customer_name"])){
							$booking=$_POST["bookingID"];
							$cust=$_POST["customer_name"];
							$sql = "SELECT booking_id, last_name FROM booking WHERE booking_id='$booking' AND last_name='$cust';";
							$result = mysqli_query($conn, $sql);
								if (mysqli_num_rows($result) == 1) {
									...
									$success="Error Cancelling Booking: ";
									}
								}
								else {
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="cancel.php?cancelled=1">
