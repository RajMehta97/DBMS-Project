...
<head>
    ...
    <title>MONTE CARLO EDIT ROOM RATES</title>
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['edited']==1){
						$room_type=@$_POST['room_options'];
						$price=@$_POST['edited_price'];
						$sql="UPDATE `room` SET `price`='".$price."' WHERE `room_type`='".$room_type."';";
						$result=mysqli_query($conn,$sql);
						if($result){
							$success='PRICE UPDATED';
						}
						else{
							$success="UNABLE TO UPDATE";
						}
				}
				else{
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="roomRates.php?edited=1">
								 <label for="ROOM TYPE">Room Type</label>
                                <select name="room_options" class="form-control m-b-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="edited_price" class="form-control" placeholder=" New Price">
                                </div>								
