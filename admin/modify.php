...
<head>
    ...
    <title>MONTE CARLO MODIFY BOOKING</title>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
				...
				if(@$_GET['modify']==1){
						...
						$sql="SELECT customer_id,last_name from booking WHERE booking_id='$bookingID' AND last_name='$lastname';";
						$result=mysqli_query($conn,$sql);
						if(mysqli_num_rows($result)==1){
							$row=mysqli_fetch_array($result);
							$cust_id=$row['customer_id'];
							 echo'<div class="form-group">';
							 echo'<form role="form" method="POST" action="modify-redirect.php">';
                             echo'<label for="Customer Details">Customer Details</label>';
                             echo'<input type="text"  name="first_name" class="form-control" placeholder="First Name">';
                             echo'<input type="text"  name="last_name" class="form-control" placeholder="Last Name">';
                             echo'<input type="text"  name="email" class="form-control" placeholder="Email">';
                             echo'<input type="text"  name="contact_no" class="form-control" placeholder="Contact No">';
                             echo'<input type="text"  name="id_type" class="form-control" placeholder="ID Type">';
                             echo'<input type="number_format"  name="id_num" class="form-control" placeholder="Id Number">';
							 echo'<button type="submit" name="bookingstuff" value=" '.$bookingID. '" class="btn btn-info">Modify</button>';
							 echo'</form>';
                             echo'</div>';
							$success='Welcome to Monte Caro';
						}
						else{
							$success="Booking Not found with this Booking ID";
						}
				}
				else{
				$success='Welcome to Monte Carlo';
				}?>
                ...
                <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="modify.php?modify=1">
                                <div class="form-group">
                                    <label for="BOOKING ID">Booking ID</label>
                                    <input type="text"  name="bookingID" class="form-control" placeholder="Booking ID">
                                </div>
                                <div class="form-group">
