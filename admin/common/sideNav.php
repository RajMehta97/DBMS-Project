...
<div class="sidebar-left">
    ...
    <div class="sidebar-left-info">
        ...
        <ul class="nav nav-pills nav-stacked side-navigation">
            ...
            <li class="menu-list">
                <a href=""><i class=""></i>  <span>Bookings</span></a>
                <ul class="child-list">
                    <li><a href="modify.php"> Modify Booking</a></li>
                    <li><a href="cancel.php"> Cancel Booking</a></li>
                    <li><a href="view.php"> View All Bookings</a></li>
					<li><a href="currentGuest.php"> Current Hotel Guests </a></li>
                </ul>
            </li>
			 <li class="menu-list">
                <a href=""><i class=""></i>  <span>Room Rates</span></a>
                <ul class="child-list">
                    <li><a href="roomRates.php"> Edit Room Rates</a></li>
                </ul>
            </li>
